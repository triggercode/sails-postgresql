...
utils.buildSchema = function(obj) {
  ...
  Object.keys(obj).forEach(function(key) {
    ...
    //set type for primaryKey to UUID (needs pg extension 'uuid-ossp')
    if(attr.primaryKey && (key === 'id')){
      attr.type = 'uuid'
    }
    ...
    var str = [
      ...
      (attr.primaryKey && (attr.type === 'uuid')) ? 'DEFAULT uuid_generate_v4()' : '', //use function of pg extension 'uuid-ossp' 
